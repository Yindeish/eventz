...
type tMethod = 'google' | 'facebook' | 'apple' | 'password';
    ...
    return (
        <Tv className="flex-1 bg-white">
            <Container className="flex-1 justify-around py-10">
                ...
                <Btn
                    container={{
                        onPress: () => router.push("/(onboarding)/signin/password"),
                        // onPress: () => openOptionModal('password'),
                        className: "h-[52px] rounded-[100px]"
                    }}
                    text={{ children: "Sign in with password", className: "text-[15px]" }}
                />
                            ...
                            <Btn
                                container={{
                                    onPress: () => {
                                        ...
                                        router.push("/(onboarding)/signin/password")
                                    },
                                    className: "h-[52px] rounded-[100px]"
                                }}
